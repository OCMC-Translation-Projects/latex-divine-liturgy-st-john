...
\def\ltDocPreparedFor{aaawf}
\def\ltDocPreparedBy{mac}
\def\ltDocProjectCode{oslw.2016.001}
...
\ltDocDomain{ara}{isr}{aaawf}
\ltDocDomain{chu}{isr}{aaawf}
\ltDocDomain{heb}{isr}{aaawf}
\ltDocDomain{ukr}{isr}{aaawf}
\ltDocDomain{yid}{isr}{aaawf}
